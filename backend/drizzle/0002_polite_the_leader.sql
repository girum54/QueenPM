CREATE TYPE "public"."user_role" AS ENUM('developer', 'stakeholder');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "role" "user_role" DEFAULT 'developer' NOT NULL;--> statement-breakpoint
